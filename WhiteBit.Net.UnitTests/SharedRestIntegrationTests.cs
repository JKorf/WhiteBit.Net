...
namespace WhiteBit.Net.UnitTests
{
    ...
    internal class SharedRestIntegrationTests
    {
        ...
        private IWhiteBitRestClientV4ApiShared GetRestClient()
        {
            var collection = new ServiceCollection();
            collection.AddWhiteBit(x => x.Rest.OutputOriginalData = true);
            ...
            return sp.GetRequiredService<IWhiteBitRestClient>().V4Api.SharedClient;
        }
