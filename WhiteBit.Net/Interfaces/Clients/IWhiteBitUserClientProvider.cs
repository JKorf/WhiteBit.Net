...
namespace WhiteBit.Net.Interfaces.Clients
{
    ...
    public interface IWhiteBitUserClientProvider : IExchangeService
    {
        ...
        void InitializeUserClient(string userIdentifier, ApiCredentials credentials, WhiteBitEnvironment? environment = null);
        ...
        /// <param name="environment">The environment to use</param>
        IWhiteBitRestClient GetRestClient(string userIdentifier, ApiCredentials? credentials = null, WhiteBitEnvironment? environment = null);
        ...
        /// <param name="credentials">The credentials for the user. Required the first time a client is requested for this user unless <see cref="InitializeUserClient" /> has been called prior for this user.</param>
        /// <param name="environment">The environment to use</param>
        IWhiteBitSocketClient GetSocketClient(string userIdentifier, ApiCredentials? credentials = null, WhiteBitEnvironment? environment = null);
    }
}