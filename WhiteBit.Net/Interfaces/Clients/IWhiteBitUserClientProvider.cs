...
namespace WhiteBit.Net.Interfaces.Clients
{
    ...
    /// </summary>
    public interface IWhiteBitUserClientProvider : IExchangeService
    {
        /// <summary>
        ...
        void InitializeUserClient(string userIdentifier, WhiteBitCredentials credentials, WhiteBitEnvironment? environment = null);
        ...
        /// <param name="environment">The environment to use</param>
        IWhiteBitRestClient GetRestClient(string userIdentifier, WhiteBitCredentials? credentials = null, WhiteBitEnvironment? environment = null);
        ...
        /// <param name="credentials">The credentials for the user. Required the first time a client is requested for this user unless <see cref="InitializeUserClient" /> has been called prior for this user.</param>
        /// <param name="environment">The environment to use</param>
        IWhiteBitSocketClient GetSocketClient(string userIdentifier, WhiteBitCredentials? credentials = null, WhiteBitEnvironment? environment = null);
    }
}