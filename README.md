...
[![Docs](https://img.shields.io/badge/Docs-WhiteBit.Net-1b7f50?style=for-the-badge)](https://cryptoexchange.jkorf.dev/docs/exchange-clients?library=WhiteBit.Net)
...
The [WhiteBit.Net documentation](https://cryptoexchange.jkorf.dev/docs/exchange-clients?library=WhiteBit.Net) is the main resource for installing, configuring, and using the library.

| Resource | Description |
|--|--|
| [Client guide](https://cryptoexchange.jkorf.dev/docs/exchange-clients?library=WhiteBit.Net) | Installation, REST and WebSocket clients, authentication, dependency injection, error handling, and advanced features |
| [Examples](https://cryptoexchange.jkorf.dev/docs/exchange-clients/examples?library=WhiteBit.Net) | Common REST and WebSocket operations |
| [API reference](https://cryptoexchange.jkorf.dev/docs/exchange-clients/reference?library=WhiteBit.Net) | Client interfaces, methods, and properties |
...
For more examples and explanations, continue with the [WhiteBit.Net documentation](https://cryptoexchange.jkorf.dev/docs/exchange-clients?library=WhiteBit.Net) or browse the [compilable repository examples](https://github.com/JKorf/WhiteBit.Net/tree/main/Examples).
...
|File|Purpose|
|--|--|
|[`AGENTS.md`](AGENTS.md)|Assistant skill with core WhiteBit.Net patterns, pitfalls, and examples|
...
* Version 4.5.0 - 24 Sep 2026
    ...
    * Shared APIs
      ...
      * Added `(I)WhiteBitSharedApiClient` containing all V2 SharedApi references
      * Added `SharedApi` to `WhiteBitOptions` to provide SharedApi related options
    ...
    * Fixed startDate, endDate parameter serialization in Trading.GetUserTradesAsync endpoint
    * Fixed proxy setting not being user for internal requests

* Version 4.4.0 - 21 Aug 2026
    * Updated to CryptoExchange.Net v12.5.0
    * Added FundingCap, FundingFloor to WhiteBitFuturesSymbol model
    * Added TickSize, StepSize to WhiteBitSymbol model
    * Added MakerFeePercentage, TakerFeePercentage, PriceStep, QuantityStep to SharedSpotSymbol mapping
    * Added MakerFeePercentage, TakerFeePercentage, PriceStep, QuantityStep, UpperFundingCap, LowerFundingCap, MaxShortLeverage, MaxLongLeverage to SharedFuturesSymbol mapping
...
* Version 4.3.0 - 29 Jul 2026
    ...
    * Fixed failing error response parsing in certain situations
